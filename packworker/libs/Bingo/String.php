...
class Bingo_String
{
     ...
     * @return string
     */
	public static function array2json($arrVar, $strFromEncode='UTF-8'/*UTF8DIFF*/)
	{
	 ...
	 */	
	public static function json2array($strJson, $strToEncode='UTF-8'/*UTF8DIFF*/, $bolAssoc=true, $intDepth=NULL)
	{
     ...
     * @return string
     */
	public static function truncate($string, $intLen = 80, $strEtc = '...', $strEncode = 'UTF-8'/*UTF8DIFF*/)
	{
	 ...
	 * @param $strEncode
	 */
	public static function escapeHtml($strVar, $strEncode = 'UTF-8'/*UTF8DIFF*/)
	{
	 ...
	 * @param string $strEncode
	 */
	public static function escapeHtmlAll($strVar, $strEncode = 'UTF-8'/*UTF8DIFF*/)
	{
	 ...
	 * @param string $strEncode
	 */
	public static function escapeJs($strVar, $strEncode = 'UTF-8'/*UTF8DIFF*/)
	{
    ...
    private static function _mbCutStr($string, $length = 100, $etc = '...', $encoding = 'UTF-8'/*UTF8DIFF*/)
    {
