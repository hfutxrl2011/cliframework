 ...
 * 以下函数主要是给FE使用
 */
function h($strVar, $strEncode = 'UTF-8'/*UTF8DIFF*/)
{
	return Bingo_String::escapeHtml($strVar,$strEncode);
}
function htmlAll($strVar, $strEncode = 'UTF-8'/*UTF8DIFF*/)
{
	return Bingo_String::escapeHtmlAll($strVar,$strEncode);
}
function j($strVar, $strEncode = 'UTF-8'/*UTF8DIFF*/)
{
...
function json($arrVar, $strEncode = 'UTF-8'/*UTF8DIFF*/)
{
	return Bingo_String::array2json($arrVar, $strEncode);
}
function json2array($strVar, $strToEncode='UTF-8'/*UTF8DIFF*/)
{
	return Bingo_String::json2array($strVar, $strToEncode);
}
function c($string, $intLen = 80, $strEtc = '...', $strEncode = 'UTF-8'/*UTF8DIFF*/)
{
...
function ContentType($strType, $strCharSet='UTF-8'/*UTF8DIFF*/)
{
 ...
 * @param $strEncode
 */
function xh($strVar, $strEncode = 'UTF-8'/*UTF8DIFF*/)
{
 ...
 */
function xhf($strVar, $strEncode = 'UTF-8'/*UTF8DIFF*/)
{
    $strVar = Bingo_String::escapeHtml($strVar,$strEncode);
    if (Bingo_View_Function_Escape::$_strType == 'xhtml') {
        //转义空格
